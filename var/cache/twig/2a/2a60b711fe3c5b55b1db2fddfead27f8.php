...
class __TwigTemplate_d1fa6c77448d652f38192f9d3018e272 extends Template
{
    ...
    <div class=\"w-full grid grid-cols-4 place-content-center gap-4\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(($context["privatePictures"] ?? null));
        $context['loop'] = [
    ...
    <div class=\"w-full grid grid-cols-4 place-content-center gap-4\">
        ...
        {% for picture in privatePictures %}
        
        {% include \"./components/settings/picture_slideshow_component.twig\" with {picture: picture} %}

        {% endfor %}
    </div>
</div>", "components/settings/admin_user_pictures.twig", "/var/www/zafkiel/src/Presentation/Templates/components/settings/admin_user_pictures.twig");
    }
}
