...
class __TwigTemplate_c94942e2d31c09492d652e1ae4164283 extends Template
{
...
\t\t\t\t\t\t\t<img ";
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["admin"], "personalData", [], "any", false, false, false, 22), "profilePicture", [], "any", false, false, false, 22), "html", null, true);
...
\t\t\t\t\t\t\t\t<div class=\"w-4 h-4 rounded-full mr-2\" style=\"background-color: ";
            // line 29
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v0 = (($_v1 = $context["admin"]) && is_array($_v1) || $_v1 instanceof ArrayAccess ? ($_v1["session"] ?? null) : null)) && is_array($_v0) || $_v0 instanceof ArrayAccess ? ($_v0["color"] ?? null) : null), "html", null, true);
            yield ";\"></div>
\t\t\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t\t\t";
            // line 31
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v2 = (($_v3 = $context["admin"]) && is_array($_v3) || $_v3 instanceof ArrayAccess ? ($_v3["session"] ?? null) : null)) && is_array($_v2) || $_v2 instanceof ArrayAccess ? ($_v2["status"] ?? null) : null), "html", null, true);
            yield "
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t";
            // line 36
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["admin"], "permissions", [], "any", false, false, false, 36), "first", [], "any", false, false, false, 36), "role", [], "any", false, false, false, 36), "html", null, true);
            yield "
\t\t\t\t\t\t</td>
\t\t\t\t\t\t<td class=\"p-2\">
\t\t\t\t\t\t\t<i class=\" px-4 fa-solid fa-ellipsis-vertical hover:cursor-pointer\" onclick=\"openModal('admin-status-modal', 'admins-monitoring');\"></i>
\t\t\t\t\t\t</td>
\t\t\t\t\t</tr>
\t\t\t\t";
        }
...
\t<div class=\"fixed inset-0 bg-gray-500 bg-opacity-75 rounded-3xl transition-opacity\" aria-hidden=\"true\"></div>
...
\t\t\t\t\t\t\t\t\t<img class=\"animate-slowPulse\" src=\"/public/img/zafkiel/zafkiel_logo.png\"/>
\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t<td class=\"border-r-2 border-r-gray-300 p-2\">
\t\t\t\t\t\t\t<img {{ (loggedAdmin.name == admin.name) ? 'data-profile-picture=\"currentAdmin\"' : 'data-profile-picture=' ~ admin.name }} class=\"w-8 h-8 object-cover rounded-full inline\" src=\"{{ admin.personalData.profilePicture }}\" alt=\"Profile picture of admin: {{ admin.name }}\"/>
\t\t\t\t\t\t\t<p class=\"inline ml-2\">
\t\t\t\t\t\t\t\t{{ admin.name }}
\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t</td>
\t\t\t\t\t\t<td class=\"border-r-2 border-r-gray-300 p-2\">
\t\t\t\t\t\t\t<div class=\"flex flex-row justify-start items-center\">
\t\t\t\t\t\t\t\t<div class=\"w-4 h-4 rounded-full mr-2\" style=\"background-color: {{ admin['session']['color'] }};\"></div>
\t\t\t\t\t\t\t\t<p>
...
", "./home/zafkiel_admin_manager.twig", "C:\\wamp64\\www\\zafkiel\\src\\Presentation\\Templates\\home\\zafkiel_admin_manager.twig");
    }
}
