...
class __TwigTemplate_11630985260791f1be751c3725bd084d extends Template
{
    ...
    <form id=\"change-admin-data\" class=\"grid grid-cols-2 p-4\">
        ...
        // line 18
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 18), "profilePicture", [], "any", false, false, false, 18)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 18), "profilePicture", [], "any", false, false, false, 18), "html", null, true)) : ("./img/backoffice/core/zafkiel_logo.png"));
        ...
        yield "\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your first name...\" value=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 29), "firstName", [], "any", false, false, false, 29), "html", null, true);
        yield "\" />
            </div>
        ...
        yield "\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your last name...\" value=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 34), "lastName", [], "any", false, false, false, 34), "html", null, true);
        yield "\" />
            </div>
        </div>
        ...
        yield "\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your username...\" value=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "name", [], "any", false, false, false, 40), "html", null, true);
        yield "\" />
        </div>
        ...
        yield "\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your email address...\" value=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "emailAddr", [], "any", false, false, false, 45), "html", null, true);
        yield "\" />
        </div>
        ...
        <div class=\"col-span-2 mt-6\">
            ...
            <div class=\"flex flex-row justify-between items-center gap-x-4\">
                <div class=\"w-full\">
                    ...
                    <div class=\"relative\">
                        <input type=\"password\" id=\"admin-new-password\" name=\"password\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your new password...\" />
                ...
                <div class=\"w-full\">
                    ...
                    <div class=\"relative\">
                        <input type=\"password\" id=\"admin-confirm-password\" name=\"password\" data-value=\"\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Confirm your new password...\" />
        ...
        yield "\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your address...\" value=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 81), "street", [], "any", false, false, false, 81), "html", null, true);
        yield "\" />
                </div>
        ...
        yield "\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your city code...\" value=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 86), "postalCode", [], "any", false, false, false, 86), "html", null, true);
        yield "\" />
                </div>
        ...
        yield "\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your city...\" value=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 91), "city", [], "any", false, false, false, 91), "html", null, true);
        yield "\" />
                </div>
            </div>
    ...
    <form id=\"change-admin-data\" class=\"grid grid-cols-2 p-4\">
        ...
        <div class=\"w-fit place-self-center\">
            <img data-profile-picture=\"currentAdmin\" class=\"w-36 h-36 rounded-full object-cover\" src=\"{{ (loggedAdmin.personalData.profilePicture) ? loggedAdmin.personalData.profilePicture : './img/backoffice/core/zafkiel_logo.png' }}\" alt=\"Your profile picture.\" />
        ...
        <div>
            <div>
                <label for=\"admin-first-name\" class=\"underline\">Your first name</label><br />
                <input type=\"text\" id=\"admin-first-name\" data-value=\"{{ loggedAdmin.personalData.firstName }}\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your first name...\" value=\"{{ loggedAdmin.personalData.firstName }}\" />
            </div>

            <div class=\"mt-4\">
                <label for=\"admin-last-name\" class=\"underline\">Your last name</label><br />
                <input type=\"text\" id=\"admin-last-name\" data-value=\"{{ loggedAdmin.personalData.lastName }}\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your last name...\" value=\"{{ loggedAdmin.personalData.lastName }}\" />
            </div>
        </div>

        <div class=\"mr-6\">
            <label for=\"admin-username\" class=\"underline\">Your username</label>
            <input type=\"text\" id=\"admin-username\" data-value=\"{{ loggedAdmin.name }}\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your username...\" value=\"{{ loggedAdmin.name }}\" />
        </div>
        
        <div>
            <label for=\"admin-email\" class=\"underline\">Your email address</label>
            <input type=\"text\" id=\"admin-email\" data-value=\"{{ loggedAdmin.emailAddr }}\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your email address...\" value=\"{{ loggedAdmin.emailAddr }}\" />
        </div>
        ...
        <div class=\"mt-6 col-span-2\">
            ...
            <div class=\"flex flex-row justify-between items-center gap-x-4\">
                <div class=\"w-full\">
                    <label for=\"admin-address\" class=\"underline\">Address</label>
                    <input type=\"text\" id=\"admin-address\" data-value=\"{{ loggedAdmin.personalData.street }}\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your address...\" value=\"{{ loggedAdmin.personalData.street }}\" />
                </div>

                <div class=\"w-full\">
                    <label for=\"admin-city-code\" class=\"underline\">ZIP / Postal code</label>
                    <input type=\"text\" id=\"admin-city-code\" data-value=\"{{ loggedAdmin.personalData.postalCode }}\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your city code...\" value=\"{{ loggedAdmin.personalData.postalCode }}\" />
                </div>

                <div class=\"w-full\">
                    <label for=\"admin-city\" class=\"underline\">City name</label>
                    <input type=\"text\" id=\"admin-city\" data-value=\"{{ loggedAdmin.personalData.city }}\" class=\"w-full px-4 py-2 rounded-md text-stone-800 bg-gray-50 mt-2\" placeholder=\"Type in your city...\" value=\"{{ loggedAdmin.personalData.city }}\" />
                </div>
            </div>
        </div>
...
</div>", "./home/zafkiel_admin_profile.twig", "/var/www/zafkiel/src/Presentation/Templates/home/zafkiel_admin_profile.twig");
    }
}
