...
class __TwigTemplate_8cc7cddc475edaaeff19724e9bc81ebc extends Template
{
...
\t\t</style>
\t</head>
\t<body class=\"text-white bg-zinc-900\" data-current-admin-id=\"";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["currentAdminId"] ?? null), "html", null, true);
        yield "\">
...
\t\t\t\t";
            // line 24
            yield from $this->load("./components/slideshow/slideshow.twig", 24)->unwrap()->yield(CoreExtension::merge($context, ["pref" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 24), "slideshowPictures", [], "any", false, false, false, 24)]));
            // line 25
            yield "
\t\t\t";
        } else {
...
\t\t\t\t\t\t<img data-profile-picture=\"currentAdmin\" class=\"block w-44 h-44 mx-auto rounded-full object-cover border-2 border-solid border-white\" src=\"";
        // line 37
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 37), "profilePicture", [], "any", false, false, false, 37)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["loggedAdmin"] ?? null), "personalData", [], "any", false, false, false, 37), "profilePicture", [], "any", false, false, false, 37), "html", null, true)) : ("./img/backoffice/core/zafkiel_logo.png"));
...
\t\t\t\t\t\t\t\t<option value=\"";
            ...
            yield "\" data-path=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["app"], "favicon", [], "any", false, false, false, 89), "html", null, true);
            yield "\">
\t\t\t\t\t\t\t\t\t";
            // line 90
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["app"], "name", [], "any", false, false, false, 90), "html", null, true);
            yield "
\t\t\t\t\t\t\t\t</option>
...
\t\t\t\t\t\t\t\t<img class=\"block w-28 h-28 mx-auto rounded-full object-cover\" src=\"";
            // line 105
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["app"], "favicon", [], "any", false, false, false, 105), "html", null, true);
            yield "\" alt=\"Icon for app: ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["app"], "name", [], "any", false, false, false, 105), "html", null, true);
            yield "\"/>

\t\t\t\t\t\t\t\t<p class=\"font-semibold text-center mt-2 text-lg\">
\t\t\t\t\t\t\t\t\t";
            // line 108
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["app"], "name", [], "any", false, false, false, 108), "html", null, true);
            yield "
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t";
        // line 116
        yield from $this->load("./home/zafkiel_admin_manager.twig", 116)->unwrap()->yield(CoreExtension::merge($context, ["data" => ($context["adminData"] ?? null)]));
        // line 117
        yield "\t\t\t\t";
        yield from $this->load("./home/zafkiel_admin_profile.twig", 117)->unwrap()->yield(CoreExtension::merge($context, ["data" => ($context["adminData"] ?? null)]));
        // line 118
        yield "\t\t\t\t";
        yield from $this->load("./home/zafkiel_admin_settings.twig", 118)->unwrap()->yield(CoreExtension::merge($context, ["data" => ($context["adminData"] ?? null)]));
        // line 119
        yield "\t\t\t</main>
...
";
    ...
    {
        return array (  287 => 145,  281 => 144,  270 => 140,  266 => 139,  263 => 138,  260 => 137,  256 => 136,  242 => 124,  233 => 122,  229 => 121,  225 => 119,  222 => 118,  219 => 117,  217 => 116,  212 => 113,  201 => 108,  193 => 105,  189 => 104,  186 => 103,  182 => 102,  172 => 94,  162 => 90,  156 => 89,  153 => 88,  149 => 87,  96 => 37,  88 => 31,  82 => 28,  79 => 27,  75 => 25,  73 => 24,  70 => 23,  68 => 22,  62 => 19,  42 => 1,);
    }
...
", "home/zafkiel_desktop.twig", "/var/www/zafkiel/src/Presentation/Templates/home/zafkiel_desktop.twig");
    }
}
