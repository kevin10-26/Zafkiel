...
class __TwigTemplate_93d4a1636a27fa7fe6ff249910fd3cdd extends Template
{
...
\t\t\t\t";
        ...
        // line 20
        yield "
\t\t\t\t<button type=\"button\" class=\"px-4 py-2 mt-4 bg-gray-400 text-stone-800 rounded-md\" id=\"open-admin-slideshow\">
\t\t\t\t\tChoose a picture
\t\t\t\t</button>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t<div class=\"w-full h-1/2 indent-4\">
\t\t\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"slideshow-tab-link p-4 pr-6 hover:bg-gray-200 hover:cursor-pointer\" onclick=\"displayTab(event, 'slideshow', 'default-pictures'); toggleSlideshowGallery('on');\">
\t\t\t\t\t\t\t\t\t\t\t\t\tDefault pictures
\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t<li id=\"slideshow-refresh-user-pictures\" class=\"slideshow-tab-link p-4 pr-6 hover:bg-gray-200 hover:cursor-pointer\" onclick=\"displayTab(event, 'slideshow', 'user-pictures'); toggleSlideshowGallery('on');\">
\t\t\t\t\t\t\t\t\t\t\t\t\tMy gallery
\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"slideshow-tab-link p-4 pr-6 hover:bg-gray-200 hover:cursor-pointer\" onclick=\"displayTab(event, 'slideshow', 'upload-picture'); toggleSlideshowGallery('off');\">
\t\t\t\t\t\t\t\t\t\t\t\t\tUpload a picture
\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t<details id=\"slideshow-preview-image\" class=\"w-full indent-4 bg-gray-200\">
...
", "./home/zafkiel_admin_settings.twig", "C:\\wamp64\\www\\zafkiel\\src\\Presentation\\Templates\\home\\zafkiel_admin_settings.twig");
    }
}
